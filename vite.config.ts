...
export default defineConfig({
	...
	lint: {
		...
		ignorePatterns: ['.agents/repos/**', '**/*.gen.ts'],
		jsPlugins: [
		...
		rules: {
			...
			'@deslop/oxlint-rules/module-scope-definition': 'error',
			...
			'@deslop/oxlint-rules/no-manual-tag': 'error',
			'@deslop/oxlint-rules/no-method-pipe': 'error',
			'@deslop/oxlint-rules/no-multiline-ternary-initializer': 'error',
			...
			'@deslop/oxlint-rules/service-capability-tracing': 'error',
