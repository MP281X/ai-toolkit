...
| Owner              | Surface                                                                          |
| ------------------ | -------------------------------------------------------------------------------- |
| `AGENTS.md`        | unconditional repository behavior and writing                                    |
| Static enforcement | safely detectable validity, syntax, formatting, semantics, and graph constraints |
| Domain skill       | conditional architecture, semantics, intent, and canonical construction          |
