...
| Align    | Obtain approval for the objective, boundary, and unresolved material choices. That approval covers iteration within the boundary; seek new approval only when the objective or boundary changes. Preserve unaffected ownership, behavior, examples, references, schemas, and evidence gates. |
